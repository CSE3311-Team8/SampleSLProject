...
console.log("Importing MATC Models into DynamoDB. Please wait.");

var MATCModels = JSON.parse(readFileSync( '../data/MATC_Models.json', 'utf8'));
MATCModels.forEach(function(model) {
    var params = {
