...
/* 4/09/2022 Carlos Uresti
  ...
  This will install all the necessary dependencies for the project. After `npm install` is done, type `npm run start` to launch the project. If it does not automatically open in browswer, open [http://localhost:3000] to view it in your browser. The project will be blank as there is no public access to a back-end yet. This will be resolved with next iteration.
*/
